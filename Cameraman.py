...
def setConfiguration(newConfiguration, camera):
...
class AutomoculusCameraman(bpy.types.Operator):
    ...
    def calculateForNewBeats(self, classificationProcess, shot, frame, lastcut, initialcut, camera, scenicContext):
    ...
    def invoke(self, context, event):
        ...
        newConfiguration, shot, lastcut, target, linetarget = self.calculateForNewBeats(classificationProcess, shot, 1,
            lastcut, True, camera, scenicContext)
        setConfiguration(newConfiguration, camera)
